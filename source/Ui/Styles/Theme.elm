...
import Ui.Styles.Functions exposing (readable)
...
colors { contrastRatio } color =
  Css.mixin
    [ Css.backgroundColor (Css.hex (colorToHex color))
    , Css.color (Css.hex (colorToHex (readable contrastRatio color)))
    ]
